...
const Contact=()=>{
    return(
        <div id="Contact" className="max-w-[1040] m-auto md:pl-20 p-4 py-16">
            <h1 className="py-4 text-4xl font-bold text-center text-[#100b5e]">Contact</h1>
            <form action='https://getform.io/f/45a7d69c-e201-4f76-952e-62d6014df512' method='POST' encType='multipart/form-data'>
                ...
                <div className=" flex flex-col py-2">
                 ...
                 <button className=" bg-[#001b5e] text-gray-100 mt-4 rounded-lg p-4">Send Message</button>
            </form>
            </div>
    );
};
