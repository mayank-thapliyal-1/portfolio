...
const Projects=()=>{
    return(
<div id="Projects" className=" dark:bg-slate-900 max-w-[1040] m-auto md:pl-20 p-4 py-16">
    <h1 className="text-4xl font-bold text-center dark:text-slate-200 text-[#100b5e]">Projects</h1>
